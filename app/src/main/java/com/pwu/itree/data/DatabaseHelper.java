...
import com.pwu.itree.data.trees.Annonaceae;
import com.pwu.itree.data.trees.Araceae;
import com.pwu.itree.data.trees.Arecaeceae;
import com.pwu.itree.data.trees.Poaceae;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TBL_FAMILY = "TBL_FAMILY";
    public static final String TBL_TREES = "TBL_TREES";

    public static final String TBL_TREES_ROW = "familyType, id, commonName, scientificName, description, drawable";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(createTable(TBL_TREES, "familyType integer, id integer, commonName varchar, scientificName varchar, description varchar, drawable integer"));
        populateDB(db);
    ...
    private void populateDB(SQLiteDatabase db) {
        String tblFamilyRow = "id, commonName, scientificName, description, drawable";
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "0, '', 'Araceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "1, '', 'Arecaceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "4, '', 'Myrtaceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "5, '', 'Fabaceae: Caesalpiniodeae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "6, '', 'Fabaceae: Mimosoideae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "7, '', 'Fabaceae: Faboideae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "8, '', 'Moraceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "9, '', 'Dipterocarpaceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "10, '', 'Meliaceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "11, '', 'Sapindaceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "12, '', 'Apocynaceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "13, '', 'Rubiaceae', " +
        ...
        db.execSQL(insertQuery(TBL_FAMILY, tblFamilyRow, "14, '', 'Lamiaceae', " +
        ...
        Araceae.insert(db);
        Arecaeceae.insert(db);
        Poaceae.insert(db);
        Annonaceae.insert(db);
